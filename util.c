...
int sendmail(char* subject, char* error)
{
	bool bError = false;
	const char* login = "djazot@gmail.com";
	const char* password = "FS12@#sK2";
	const char* sendername = "noreplyRigInfo";
	const char* sendermail = "noreply@gmail.com";
	const char* recipient = "djazot@gmail.com";
